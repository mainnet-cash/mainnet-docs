...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.7.12.js"
   integrity="sha384-VPeMtMSg1+qwYXvNQN1wB4TOTOp9tjdxHBtbVQxw3TA1brLb4fO4W1uzUa3OzVcH"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.7.12.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.7.12.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.7.12.js"
 integrity="sha384-eoKrtZ9kTn4nkEe8kX4vJhgnoylK9jS2P8lzClBk0XaHRbtf9IbnsTe1fEdg4pRw"
 crossorigin="anonymous"></script>
```
