...
```html
<script src="https://cdn.mainnet.cash/mainnet-1.0.6.js"
 integrity="sha384-cruc1Jidl7yPmlMzd2XZE9aQJxPAKV78cc1+kg7WEmBnWQ6QGhVb8RmmtFNBgy8k"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.0.6.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-1.0.6.js"
 integrity="sha384-4dAZpFYdxarD4YzV8BcmzFD73uqhiqsSgTVUOwqG5ssDa+L4O/fGYyL0YkMgEkSw"
 crossorigin="anonymous"></script>
```
