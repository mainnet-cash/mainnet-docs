...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-1.1.6.js"
   integrity="sha384-RNL1iSIK2B70eLJpt5vH6ALzm7uqw886XHW/8ewc+qeND43xHEYNz/xadiZKZ4Au"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.1.6.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
<script src="https://cdn.mainnet.cash/contract/contract-.js"
 integrity="sha384-y6TlHK7B2CQifNV1ryHYIEy0lodIfLMDmszagURymOBfFfAKFEX9qHewe6wJ/mgq"
 crossorigin="anonymous"></script>
```
