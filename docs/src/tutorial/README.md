...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.3.13.js"
   integrity="sha384-o5Z+PVqs32CuZafxzkDaVPMfi16H7fR3U/+10fiN2iYlXK+T5SLIpUVDDXb2ip5h"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.3.13.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.3.13.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.3.13.js"
 integrity="sha384-GVC0MF+U85lSTIvxMJ6O57Wpmb5GhM4gp9VfFfjf4/bJhnSouGUjoM60dUmtIwE+"
 crossorigin="anonymous"></script>
```
