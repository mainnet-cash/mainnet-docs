...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.4.1.js"
   integrity="sha384-Vr0ii9tsErwasbm8cxKRLvCcKs5tiFX+H1xKpDmba+hy3HEwf1wZsXhlKAJ4rUFd"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.4.1.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.4.1.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.4.1.js"
 integrity="sha384-myXBqVqRgHWhPvyMKNIzsWvNAocPD23lVD+wgdmBH2fO+XKhHS0qxcc8MtLProZ0"
 crossorigin="anonymous"></script>
```
