...
```html
<script src="https://cdn.mainnet.cash/mainnet-0.3.3.js"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-0.3.3.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
