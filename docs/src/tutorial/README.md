...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.7.9.js"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.7.9.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.7.9.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.7.9.js"
 integrity="sha384-OLBgp1GsljhM2TJ+sbHjaiH9txEUvgdDTAzHv2P24donTt6/529l+9Ua0vFImLlb"
 crossorigin="anonymous"></script>
```
