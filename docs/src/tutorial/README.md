...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.4.0.js"
   integrity="sha384-keqs/RTk1Qvb6HNJaQtz93vBY9Ad6K5CbWVT4+0Ub1cgw9UpOnWqBeOibYrx8PUJ"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.4.0.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.4.0.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.4.0.js"
 integrity="sha384-ZpgfJN/vmRIUUAbRZJU8mvHyYomF6Yctuzh+uIO08WerNAR+LGho42Q2oRo7BCdF"
 crossorigin="anonymous"></script>
```
