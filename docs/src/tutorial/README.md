...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.6.5.js"
   integrity="sha384-YCPJgE/7opion8RbsTiKl/QaC8PJf2YDZM5P9LTQSAFG4f6cgOndGqtfXRyJhJK4"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.6.5.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.6.5.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.6.5.js"
 integrity="sha384-a8YYSBlAKKK+dF8QV+v9gLgnPZkPpa2Jzn4ETD0CQ+YbgNqG9BLnFXJG1p4Jlrfb"
 crossorigin="anonymous"></script>
```
