...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.3.14.js"
   integrity="sha384-g1rj/6m4pPGeAfh0XM823BIDdyoxjCusFU+3j3zti0mkncyjjJvaVDmb3e2/bwbw"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.3.14.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.3.14.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.3.14.js"
 integrity="sha384-4+UjlnJGewMaVWVriimgMDmrDe+JIBZntR+kTigMv63HCShzxt+vz3v5mh/R705a"
 crossorigin="anonymous"></script>
```
