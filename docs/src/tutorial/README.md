...
```html
<script src="https://cdn.mainnet.cash/mainnet-1.0.5.js"
 integrity="sha384-e981PbZRzsblFg+bdp2uTd1QAe/IhDdF74CtBxY6VGTQNp9lPLPvbkkhabu04Zhl"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.0.5.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-1.0.5.js"
 integrity="sha384-QmFFRcFoK00tnqOcc6shrLYES4vzCOJnv2r8KghLFWxn3F98DW3ttke1Jz+tjdE6"
 crossorigin="anonymous"></script>
```
