...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.3.15.js"
   integrity="sha384-6zLX2inaUdXRvTpcHS/uPcHFwiqOk5XS5U5Ma+x9E+VlvJdsEECRqKQI1m8XxX1d"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.3.15.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.3.15.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.3.15.js"
 integrity="sha384-FPhfnBEojNwaKc4s/z3a0NOL4pJVQITTKFqrGy5Bb721MFBSraa/pGPJVPgcDJcp"
 crossorigin="anonymous"></script>
```
