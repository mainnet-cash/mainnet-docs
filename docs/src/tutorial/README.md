...
```html
<script src="https://cdn.mainnet.cash/mainnet-0.2.5.js"
 integrity="sha384-XYDHw37MVT/U1nnTe2wYARpGFUSMyr4yjD1wPcPyOlzboAHEsm9Yyu/KzTP1PKT8"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-0.2.5.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
