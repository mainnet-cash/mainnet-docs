...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.3.3.js"
   integrity="sha384-yc2g480sL35tqWN5Ki20D//ZvQI7oUGrHZ0EFaeuJs4tvG6HaVInXqe7RSrHbbSG"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.3.3.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.3.3.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.3.3.js"
 integrity="sha384-e2Qg1yGqBL3xF5wdtk9reVqeF/Wl0eIgryobojftkQY6SpmNkYBZFxcP1/a15FDz"
 crossorigin="anonymous"></script>
```
