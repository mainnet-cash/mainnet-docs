...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.7.15.js"
   integrity="sha384-sDBC21+XPhOiMN4rQPS9bJS67FCyt0O5TMNjFMbCusiPnAsUm4ZBamctsTogYS/X"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.7.15.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.7.15.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.7.15.js"
 integrity="sha384-YaH1OpCXsG70lxTwBtA+jMUSx/VDsKXK0DMef1VfbaJlbPTKT8IwfdFDjTLe0Sp8"
 crossorigin="anonymous"></script>
```
