...
```html
<script src="https://cdn.mainnet.cash/mainnet-0.3.9.js"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-0.3.9.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
