...
```html
<script src="https://cdn.mainnet.cash/mainnet-0.4.11.js"
 integrity="sha384-Jdt1bPVX3PjeJHWNxjSMes96WObu4qmQj80QAs2rHctEnftuo8vpmWUtuoKPhKGQ"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-0.4.11.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-0.4.11.js"
 integrity="sha384-p7UQfUbFaRIeAwcLV8y2FiJhfhnl8LN/2ort10Z8TgJ/iuHjiEEZOz4kIGQg8mA5"
 crossorigin="anonymous"></script>
```
