...
```html
<script src="https://cdn.mainnet.cash/mainnet-1.0.11.js"
 integrity="sha384-VXSv11DImSWaZgCGFsfRPjouxz/hIEWYPZrVnokLPiDqmkD4CnW0ex0wRMI2ZfKM"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.0.11.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-1.0.11.js"
 integrity="sha384-54Gneu/6NiJLpTvL2xTTNYsCitzAWczbX2/HP95HRIM3hr69BlG7qARtdxoBLxri"
 crossorigin="anonymous"></script>
```
