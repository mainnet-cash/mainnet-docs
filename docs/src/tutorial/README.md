...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.3.1.js"
   integrity="sha384-rxW19gNnAHA0hEayxDOvWkT4HB3G9PaTZ+vfCPlTGU7c4sdGe+9GnbWPEEndBb8S"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.3.1.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.3.1.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.3.1.js"
 integrity="sha384-gitFpbGg2AZ6A/Swv8iWVB5YPic8fCQjR6vGAQiJ9mbS2WPL6JNJlpxO6ekihSLa"
 crossorigin="anonymous"></script>
```
