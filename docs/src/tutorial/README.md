...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.5.0.js"
   integrity="sha384-3r2QY5vZDcK1+yvyHmyxmj/Ouil4yY00bnEPxVstE7EA01a4zZ5ByXYm3WMfcn81"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.5.0.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.5.0.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.5.0.js"
 integrity="sha384-bnUWHxQy889KIgGpMoh3zg18PdGax6jKQ0wfRZBDK2bHJXYnoUpbgbdOYPfvsQjV"
 crossorigin="anonymous"></script>
```
