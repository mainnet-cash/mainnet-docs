...
```html
<script src="https://cdn.mainnet.cash/mainnet-1.0.14.js"
 integrity="sha384-Xx3F77oZ34FnkkTkCzwSp7dXy9dR4VJ3+B8Uz2+/Bpb3TxzqGPWtSkvqoV9BauXj"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.0.14.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
<script src="https://cdn.mainnet.cash/contract/contract-.js"
 integrity="sha384-I7Q7Chbb84ZCS/+BGis6o2VVcvaLK11tRtUVXLfcSsUfG5GEd4o+ok1byiyjDryF"
 crossorigin="anonymous"></script>
```
