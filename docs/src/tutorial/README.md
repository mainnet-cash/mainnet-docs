...
```html
<script src="https://cdn.mainnet.cash/mainnet-0.4.22.js"
 integrity="sha384-fDsI/a3sNR9usy8syA+2xl4wy3fp2dhP6ixJanT7eq7PKYbjdS9IS24PTT6PkCkT"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-0.4.22.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-0.4.22.js"
 integrity="sha384-tA3evg0PLs3BGFay2oGpmuuTuZBc+94aqqi9NdIfiKKZl+p4otePj6z+/ww5W/YW"
 crossorigin="anonymous"></script>
```
