...
```html
<script src="https://cdn.mainnet.cash/mainnet-1.0.1.js"
 integrity="sha384-dYg42PZKpgMOjo8kE31CjWixIyMihOXxTTKvKBRXVS0FqQ+NLAcZ6IrGwYOOmR/O"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.0.1.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-1.0.1.js"
 integrity="sha384-pob55yITHyJQtEQOACq9vIHSZWOCB18fv6HJ839C/mM6lEYZEjItPeX1QG6mvQNY"
 crossorigin="anonymous"></script>
```
