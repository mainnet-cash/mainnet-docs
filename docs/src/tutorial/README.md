...
```html
<script src="https://cdn.mainnet.cash/mainnet-1.0.4.js"
 integrity="sha384-uB4SaeVde/W29hqaPwPSD8zKBfvZPQJ9iWwWNRmWEjtonPvikWbdEeEarLbmOnVF"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.0.4.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-1.0.4.js"
 integrity="sha384-5skbBe+apWjhtwnSVhmLFJpOnFqCYXf3amQsP6PIvpAbERzEOAShEt9IFKNZpRWM"
 crossorigin="anonymous"></script>
```
