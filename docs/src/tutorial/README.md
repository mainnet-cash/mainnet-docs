...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.3.16.js"
   integrity="sha384-g/V7fuhNI7XxQN/ih2EBaeVCc6mhYpTMUKPlAILNfOsxDqwV72tbLc5sdWwgeFDL"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.3.16.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.3.16.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.3.16.js"
 integrity="sha384-IG/3zJ93iw97DPkXchlk1EnYIqNYT1Al9+yD99+qXaakS7lpFgrCj2naCBcJqegw"
 crossorigin="anonymous"></script>
```
