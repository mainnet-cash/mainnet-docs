...
```html
<script src="https://cdn.mainnet.cash/mainnet-1.0.7.js"
 integrity="sha384-Bdq22RYNuEjVrHl9JtMWQDLOyRad1spuiyz4UksGhEIb4oXwZky4iSwxdLDvmDlB"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.0.7.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-1.0.7.js"
 integrity="sha384-LJwHTUBeikoRg1oTdH2/TkEZ1qoEZ+OabGhTLUIknoQTIotZhh4O7Zb+VCUUHLcZ"
 crossorigin="anonymous"></script>
```
