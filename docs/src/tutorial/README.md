...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-1.1.12.js"
   integrity="sha384-JsS7BsUVpNtJgMJeFATWlcITxgeTt3Ekcdh9G9eTNf7EdJ0zxoNWUlvksYej/XiT"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.1.12.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
<script src="https://cdn.mainnet.cash/contract/contract-.js"
 integrity="sha384-22Nuc+tqcyXZjnSMJsrD7ragmCp9aONa9eOEp430bhxF+mbRY/vqYJXRZav5YuHz"
 crossorigin="anonymous"></script>
```
