...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-1.1.10.js"
   integrity="sha384-PSNjRtIK415f2mHZyFM4H0MzakVQTnnwdOu81jNuHVsYIt4hz1h4PYElDxMFLscx"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.1.10.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
<script src="https://cdn.mainnet.cash/contract/contract-.js"
 integrity="sha384-ee0PoP1Tko69fwp0v8TQJSIMa9oD2Hewhs76iX1voJ+aYMjmtbc2rglHZpiZSGdy"
 crossorigin="anonymous"></script>
```
