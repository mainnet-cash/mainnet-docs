...
```html
<script src="https://cdn.mainnet.cash/mainnet-0.3.34.js"
 integrity="sha384-3LFOdE/NWgzUrTD+TPCC/0eimr2ch8IEe7gyCMWiIYWPqEH+LAUXQB84MsYs4sv/"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-0.3.34.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
