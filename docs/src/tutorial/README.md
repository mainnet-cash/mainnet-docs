...
```html
<script src="https://cdn.mainnet.cash/mainnet-1.0.0.js"
 integrity="sha384-D2AZn2vEG6KF5T+ELvWc6Z7nQ05PHNOrC9TtAbkZSLGeBVmVFJz83vp3Jh4WkNwH"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.0.0.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-1.0.0.js"
 integrity="sha384-chasQLjFNkybTcnCfn/q/XagN+msBMj6qvyLju9ddfy9dDBmi7KoRxYGEMRsArsX"
 crossorigin="anonymous"></script>
```
