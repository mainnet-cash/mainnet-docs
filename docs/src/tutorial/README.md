...
```html
<script src="https://cdn.mainnet.cash/mainnet-1.0.2.js"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.0.2.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-1.0.2.js"
 integrity="sha384-2rHb3Ad0asUHmx7dJcWspyfebpOnYhpG0b7Zg5biAxTJAzlOGXSJJ855NlvK/FYl"
 crossorigin="anonymous"></script>
```
