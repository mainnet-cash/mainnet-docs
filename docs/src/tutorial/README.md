...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.3.7.js"
   integrity="sha384-xyhUcEqqWmKMdKok/BZDNFudd2UJ63/gkzbaUdWW+Eecp0qnFOfYetEr3IzTE98C"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.3.7.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.3.7.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.3.7.js"
 integrity="sha384-6RZHaOmZ5GdIc9gyU/wcMZRKTxw8YdoZqjvO1mhcXK2gax/yNjGWNf5vevPNB75A"
 crossorigin="anonymous"></script>
```
