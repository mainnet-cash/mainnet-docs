...
```html
<head>
  <script src="https://cdn.mainnet.cash/mainnet-2.2.8.js"
   integrity="sha384-NswiNvbLm1lC8zX4UW8VCrbBDmqJMg4rZuRE76NavhPS80E9PLNRs3IQ2ZF0dFWk"
...
echo sha384-`curl https://cdn.mainnet.cash/mainnet-2.2.8.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```js
<head>
  <script src="https://cdn.mainnet.cash/indexeddb-storage/indexeddb-storage-2.2.8.js"
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-2.2.8.js"
 integrity="sha384-tsaSUTw6BLYmyVgmFGt+p/voYsawHSLnpRlkvJGbE4p4K4QnC1IKuO66E3eYK4U4"
 crossorigin="anonymous"></script>
```
