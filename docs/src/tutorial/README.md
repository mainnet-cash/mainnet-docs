...
```html
<script src="https://cdn.mainnet.cash/mainnet-1.0.3.js"
 integrity="sha384-oQwvdHyn83IWH86nFxJH7LR64KCzdfn++as1EDXotJ0gCHm2qzqkLUFE96q8ohOf"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-1.0.3.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
...
```html
<script src="https://cdn.mainnet.cash/contract/contract-1.0.3.js"
 integrity="sha384-asCNesnjvvOjxhFSURX9DFbJnneMW4DHJYbAT+g6dKLTTWXn16Z4sIXVm4KCBvlA"
 crossorigin="anonymous"></script>
```
