...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-0.4.35.js"
 integrity="sha384-2f6lB+9PN+JfyBf1QD9JdA8FYpZsyj+MGs6sRqZbprGLhh/Z9jvWA3Lc/BGsLmqe"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-0.4.35.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
