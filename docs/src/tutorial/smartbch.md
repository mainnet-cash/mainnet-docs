...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-0.5.7.js"
 integrity="sha384-X0qBEFX8x7QleYKeZXQZRY0cFeN8wpR6pTIyHXX3u3cZXtkMp//aEQ4OX8sa/SBv"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-0.5.7.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
