...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-0.4.31.js"
 integrity="sha384-k69T16b/9Fsptz/LRQNEz1S5WRmgcDHeKDPMOVBgD7WeSAK148OonhvA+uUgRsQZ"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-0.4.31.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
