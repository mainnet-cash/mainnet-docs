...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-1.0.9.js"
 integrity="sha384-NsJVvmfyRQYckBflbzWNpEuB8VeRe+Ch33AIIp6L9ToJo24XfRSZ/zfmIdWGVVYs"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-1.0.9.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
