...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-0.4.14.js"
 integrity="sha384-8Xcc+a1OmLQNy/++eviMNVdxZER5bFO6YituY0vBpfDi5OFp8hQmNOLYb8qOkDO5"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-0.4.14.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
