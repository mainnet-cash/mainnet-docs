...
```html
<script src="https://cdn.mainnet.cash/mainnet-0.4.3.js"
 integrity="sha384-prNHaXGeTGWwsyc0WSTlMRgd3kpuy59eh90flybICZsr499pdHqf55FuCG69dO9l"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-0.4.3.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
