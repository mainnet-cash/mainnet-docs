...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-1.0.7.js"
 integrity="sha384-jMIV43tXsMqYWEK5uAvPT2/dVy61cJ96RxRklnJ/idh2T+x84watxgBr9v1oMaF5"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-1.0.7.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
