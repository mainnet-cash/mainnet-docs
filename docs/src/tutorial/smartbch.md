...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-0.4.30.js"
 integrity="sha384-zLIN8rr8DcGYrF/6Nq6+IVensouSu/7gMjZZPYrzUam9pdnwnWV5KfapD+bv5N+B"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-0.4.30.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
