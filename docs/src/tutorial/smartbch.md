...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-0.4.15.js"
 integrity="sha384-QzjH0CPnkWRBKrGJ9t+nnkzseEGrAXVOBpLCFSJq43CdVocGQlPwGWKObsmtxSMK"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-0.4.15.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
