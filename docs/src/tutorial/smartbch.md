...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-1.0.5.js"
 integrity="sha384-CshQSU1bgVrorh00TESIPUbX5tn7Gelky3PqD+h0eDNv2bRrcfHcMzBhM/c40gNx"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-1.0.5.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
