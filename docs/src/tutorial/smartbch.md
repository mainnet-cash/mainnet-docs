...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-0.4.9.js"
 integrity="sha384-9nQehZufHhdKJ+cRbCeXHmtNYzF2SodPyD9vVegvnh9EPNvgv6geI+2UyjLcJwZ+"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-0.4.9.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
