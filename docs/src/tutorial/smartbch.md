...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-0.4.29.js"
 integrity="sha384-yqQSQhjhFA2z9EtImKrsAipDw0fjTziSmdpQY8SDI3GywQykAeDEz7a3PrlTadeM"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-0.4.29.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
