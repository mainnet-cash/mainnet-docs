...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-1.0.6.js"
 integrity="sha384-srzX67XRFzYDA3xR691lD4+ylKoabODr41n3Mwk3YjUJG7ACtftvaz+OP3HibLlw"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-1.0.6.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
