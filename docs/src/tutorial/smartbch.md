...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-0.4.40.js"
 integrity="sha384-37rdL1D8NhbRAL4Xay/BvmpZRfJcyw/mv71UhHmcauQMU/NEMzsICxB6HepglH0L"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-0.4.40.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
