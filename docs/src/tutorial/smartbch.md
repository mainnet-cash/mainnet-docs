...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-0.4.25.js"
 integrity="sha384-K95blJuwZryFEBgLf7mDoeSXTSzoyUVE13rh+jU7zY2JTkxrDnL5WpUzM/eIH5op"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-0.4.25.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
