...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-0.4.39.js"
 integrity="sha384-v8yrywo7qE1wWsU1v4QztZIKalS1itIBFQXjxV8KCCC5aJE8gwRwk5OGJfdCp5Jc"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-0.4.39.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
