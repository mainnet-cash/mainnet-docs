...
```html
<script src="https://cdn.mainnet.cash/mainnet-0.4.2.js"
 integrity="sha384-iYWU4u8bZ1GI6I4YwBhfem+9LLS9cuXdr/3Lj5U5sNWsUu3DCTTVX19nneaaWVVC"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/mainnet-0.4.2.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
