...
```html
<script src="https://cdn.mainnet.cash/smartbch/smartbch-1.0.8.js"
 integrity="sha384-Z7TRpHvD5369Fo1lzrQ+6TlYNHZLZUP/rSOHeA85/i95tdgPRCoIyhofoWYbaYwT"
 crossorigin="anonymous"></script>
```

<!--
you can generate the integrity sha like in the following example:
echo sha384-`curl https://cdn.mainnet.cash/smartbch/smartbch-1.0.8.js | openssl dgst -sha384 -binary | openssl base64 -A`
-->
